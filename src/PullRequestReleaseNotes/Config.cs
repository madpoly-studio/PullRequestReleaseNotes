...
namespace PullRequestReleaseNotes
{
    public class Config
    {
        ...
        {
            // general settings
            _programArgs.ExcludeLabel ??= args.ExcludeLabel;
            _programArgs.GitRemote ??= args.GitRemote;
            ...
            _programArgs.ReleaseNoteOrderWhen ??= args.ReleaseNoteOrderWhen;
            _programArgs.ReleaseNoteSectionlessDescription ??= args.ReleaseNoteSectionlessDescription;
            _programArgs.ReleaseNoteUncategorisedDescription ??= args.ReleaseNoteUncategorisedDescription;
            _programArgs.ReleaseNoteHighlightLabels ??= args.ReleaseNoteHighlightLabels;
            _programArgs.ReleaseNoteCategorised ??= args.ReleaseNoteCategorised;
            _programArgs.ReleaseNoteOrderAscending ??= args.ReleaseNoteOrderAscending;
            _programArgs.ReleaseNoteSectioned ??= args.ReleaseNoteSectioned;
            _programArgs.ReleaseBranchHeadsOnly ??= args.ReleaseBranchHeadsOnly;
            _programArgs.ReleaseNoteSections ??= args.ReleaseNoteSections;
            _programArgs.ReleaseNoteCategories ??= args.ReleaseNoteCategories;
            _programArgs.PullRequestProviderName ??= args.PullRequestProviderName;
            ...
            _programArgs.GitHubApiUrl ??= args.GitHubApiUrl;
            _programArgs.GitHubOwner ??= args.GitHubOwner;
            _programArgs.GitHubRepository ??= args.GitHubRepository;
            _programArgs.GitHubToken ??= args.GitHubToken;
            _programArgs.GitLabOwner ??= args.GitLabOwner;
            _programArgs.GitLabRepository ??= args.GitLabRepository;
            _programArgs.GitLabApiUrl ??= args.GitLabApiUrl;
            _programArgs.GitLabProjectId ??= args.GitLabProjectId;
            _programArgs.GitLabToken ??= args.GitLabToken;
            _programArgs.TfsApiUrl ??= args.TfsApiUrl;
            _programArgs.TfsCollection ??= args.TfsCollection;
            _programArgs.TfsRepository ??= args.TfsRepository;
            _programArgs.TfsUsername ??= args.TfsUsername;
            _programArgs.TfsToken ??= args.TfsToken;
            _programArgs.BitBucketServerUrl ??= args.BitBucketServerUrl;
            _programArgs.BitBucketServerUsername ??= args.BitBucketServerUsername;
            _programArgs.BitBucketServerPassword ??= args.BitBucketServerPassword;
            _programArgs.BitBucketServerProject ??= args.BitBucketServerProject;
            _programArgs.BitBucketServerRepository ??= args.BitBucketServerRepository;
            _programArgs.BitBucketApiKey ??= args.BitBucketApiKey;
            _programArgs.BitBucketApiSecret ??= args.BitBucketApiSecret;
            _programArgs.BitBucketAccount ??= args.BitBucketAccount;
            _programArgs.BitBucketRepository ??= args.BitBucketRepository;
            ...
            _programArgs.OutputFileName ??= args.OutputFileName;
            _programArgs.ConfluenceApiUrl ??= args.ConfluenceApiUrl;
            _programArgs.ConfluenceUser ??= args.ConfluenceUser;
            _programArgs.ConfluencePassword ??= args.ConfluencePassword;
            _programArgs.ConfluenceReleaseParentPageId ??= args.ConfluenceReleaseParentPageId;
            _programArgs.ConfluenceSpaceKey ??= args.ConfluenceSpaceKey;
            _programArgs.SlackChannels ??= args.SlackChannels;
            _programArgs.SlackToken ??= args.SlackToken;
        }

        private void MergeDefaults()
        {
            _programArgs.ExcludeLabel ??= "Exclude Note";
            _programArgs.GitRemote ??= "origin";
            _programArgs.OutputFileName ??= "Unreleased.md";
            _programArgs.ReleaseNoteCategoryPrefix ??= "#";
            _programArgs.ReleaseNoteDateFormat ??= "MMM dd, yyyy HH:mm";
            _programArgs.ReleaseNoteFormat ??= "{0} {1}";
            _programArgs.ReleaseNoteOrderWhen ??= "merged";
            _programArgs.ReleaseNoteSectionlessDescription ??= "Undefined";
            _programArgs.ReleaseNoteUncategorisedDescription ??= "Unclassified";
            _programArgs.GitHubApiUrl ??= "https://github.com";
            _programArgs.GitLabApiUrl ??= "https://gitlab.com";

            _programArgs.ReleaseNoteCategorised ??= false;
            _programArgs.ReleaseNoteOrderAscending ??= false;
            _programArgs.ReleaseNoteSectioned ??= true;
            _programArgs.ReleaseBranchHeadsOnly ??= true;

            _programArgs.ReleaseNoteSections ??= new List<string>() { "bug=Fixes", "enhancement=Enhancements" };
        }

        public bool SetupPullRequestProvider()
        {
            _programArgs.PullRequestProviderName ??= "github";
            try
            {
